...
public class ServiceNowTaskView implements StepPlugin, Describable, ConfiguredBy<ServiceNowCommunity> {

  public static final String PLUGIN_NAME = "servicenow-task-view"
  public static final String PLUGIN_TITLE = "ServiceNow / Task / View"
  public static final String PLUGIN_DESCRIPTION = "View a ServiceNow Task"
  ...
  public void executeStep(final PluginStepContext context, final Map<String, Object> configuration) throws StepException {
    ...
    logger.log(3, "Accessing ServiceNow for task ${taskNum}...")
    ...
    try {
      ...
      logger.log(3, "Querying for task ${taskNum}...")
      String result = JsonOutput.toJson(client.taskGetDetails(taskNum))
      logger.log(2, result)
    } catch (Exception e) {
