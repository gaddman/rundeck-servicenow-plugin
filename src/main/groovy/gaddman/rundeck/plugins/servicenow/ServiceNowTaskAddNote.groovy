...
public class ServiceNowTaskAddNote implements StepPlugin, Describable, ConfiguredBy<ServiceNowCommunity> {

  public static final String PLUGIN_NAME = "servicenow-task-add-note"
  public static final String PLUGIN_TITLE = "ServiceNow / Task / Add note"
  public static final String PLUGIN_DESCRIPTION = "Add a note to a ServiceNow Task"

  private static final String CONFIG_TASKNUM = "taskNum"
  private static final String CONFIG_NOTE = "note"
  ...
  public void executeStep(final PluginStepContext context, final Map<String, Object> configuration) throws StepException {
    ...
    String note = configuration.get(CONFIG_NOTE);
    ...
    try {
      ...
      logger.log(3, "Adding note for task ${taskNum}...")
      client.taskAddNote(taskNum, note)
      logger.log(2, "Note added successfully")
    } catch (Exception e) {
